...
document.addEventListener('webviewerloaded', function(event) {
  ...
  // window.history.replaceState(null, "Test", "http://lib.symbiotic.ai/index.php/apps/files/?dir=/ZoteroLibrary&fileid=12#pdfviewer");
  // document.getElementsByTagName("iframe")[0].contentWindow.history.replaceState(null, "Test", "lib.symbiotic.ai");
